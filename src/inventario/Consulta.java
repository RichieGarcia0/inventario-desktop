...
public class Consulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(cFecRec2, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cFecEje, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cFecEje2, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Gaceta", "Tipo", "Tomo", "Páginas", "Fecha", "Tiraje", "Existencia", "Recepción", "Persona", "Director", "Hemeroteca", "Ruta", "Módulo", "Suscripciones", "Digital"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Object.class
            };
    ...
    private void btBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarActionPerformed
        ...
        try {
            ...
            for (int i = jTable1.getColumnCount() - 7; i >= 0; i--) {
            ...
            if (!cNumGac.getText().isEmpty() && cFecEje.getDate() == null && cFecEje2.getDate() == null && cFecRec.getDate() == null && cFecRec2.getDate() == null) {
                ...
                while (rs.next()) {
                    modelo.addRow(new Object[]{
                        ...
                        new String(rs.getString(9)), // Persona
                        new Boolean(rs.getBoolean(12)), // Director
                        new Boolean(rs.getBoolean(13)), // Hemeroteca
                        new Boolean(rs.getBoolean(14)), // Ruta
                        new Boolean(rs.getBoolean(15)), // Módulo
                        new Boolean(rs.getBoolean(16)), // Suscripciones
        ...
        if (fila < jTable1.getRowCount() && fila >= 0 && columna < jTable1.getColumnCount() && columna >= 0) {
            ...
            if (value instanceof JButton) {
                ...
                try {
                    ...
                    ResultSet rs;
                    PreparedStatement pst;
                    String sql = "SELECT * FROM gacetas WHERE id = ?";
                    pst = c.prepareStatement(sql);
                    pst.setString(1, jTable1.getModel().getValueAt(fila, 0).toString());
                    rs = pst.executeQuery();

                    if (rs.next()) {
                        File path = new File(rs.getString(6)); // Obtiene ruta de la base de datos
                        Desktop.getDesktop().open(path);
                    } else {
                        JOptionPane.showMessageDialog(null, "No se encontró el archivo", null, JOptionPane.ERROR_MESSAGE);
                    }
                    bd.Desconectar();
                } catch (SQLException ex) {
                    Logger.getLogger(Consulta.class.getName()).log(Level.SEVERE, null, ex);
